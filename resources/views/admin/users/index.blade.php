<x-app-layout>
    ...
    <!-- Top-up Modal -->
    <div x-data="topupModal" 
         x-show="isOpen" 
         @open-topup-modal.window="openModal($event.detail)"
         x-cloak 
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="isOpen" 
                ...
                <div class="p-6">
                    <div class="mb-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800">
                        <div class="flex justify-between items-center">
                            <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Saldo Saat Ini</span>
                    ...
                    <div class="relative">
                        <span class="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-amber-500">diamond</span>
                        <input type="number" 
                               x-model="amount"
                               min="1"
                ...
                <div class="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-3">
                    ...
                    <button @click="submitTopup" :disabled="isSubmitting || amount <= 0"
                        class="px-6 py-2.5 bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-bold rounded-xl shadow-lg shadow-emerald-500/20 transition-all flex items-center gap-2">
        ...
        function topupModal() {
            return {
                ...
                openModal(detail) {
                    ...
                    this.currentBalance = detail.balance;
                    this.amount = 1000;
                    this.isOpen = true;
                },
