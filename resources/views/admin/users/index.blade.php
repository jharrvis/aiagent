<x-app-layout>
    <div class="py-12" x-data="{
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            @else
                                                <div class="flex flex-col">
                                                    ...
                                                    <button
                                                        @click="openModal({{ $user->id }}, @js($user->name), {{ $user->token_balance }})"
        ...
        <!-- Top-up Modal -->
        <div x-show="isOpen" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
